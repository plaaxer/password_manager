...
def encrypt_with_salt(username: str, password: str, fernet: Fernet, salt: bytes) -> tuple:
    ...
    """
    encrypted_username = encrypt_data(username.encode(), fernet)
    encrypted_password = encrypt_data(password.encode(), fernet)
...
def get_decrypted(encrypted_username: str, encrypted_password: str, master_key: str) -> tuple:
    ...
    decrypted_username_bytes = decrypt_data(encrypted_username_bytes, fernet)
    decrypted_password_bytes = decrypt_data(encrypted_password_bytes, fernet)
